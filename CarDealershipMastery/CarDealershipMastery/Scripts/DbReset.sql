...
BEGIN
	...
	INSERT INTO Model(ModelId, ModelType)
	VALUES(1, 'Dodge'),
	(2, 'Ford'),
	(3, 'Tesla');
	...
	INSERT INTO Make(MakeId, MakeType)
	VALUES(1, 'Ram'),
	(2, 'F-150'),
	(3, 'Model S');
	...
	VALUES(1, '00000000-0000-0000-0000-000000000000', 1, 1, 1, 1, 1, 2, 2, '2020', 'New', 12345678920987465, 150.00, 135.00, 'Brand New Car', 'Image file path', 0),
	(2, 'dp', 1, 1, 1, 1, 2, 2, 2, '2020', '15,000', 150000984575673829, 150.00, 125.00,'Brand New Car', 'Image file path', 1);
	...
	PurchaseTypeId)
	VALUES( 1, 'sa', 'Dean Pierrot', 'dapierrot21@gmail.com', 'Main Street Ave', 'N/A', 2, 2, 40299, 150000.00, 1
	),
	(2, 'dp', 'Kaden', 'SupercoolKid@gmail.com', 'King Street Ln', 'Main Street Ave', 2, 2, 40299, 200000.00, 2);
